  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8 space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <MetricCard title="With Custom Rate" value={projectsWithRate} />
        <MetricCard title="Using Default ($45)" value={projectsWithoutRate} />
        <MetricCard title="Default Rate" value="$45.00" />
      </div>
