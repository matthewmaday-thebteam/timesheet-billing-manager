-- ============================================================================
-- Migration 033: Fix project grouping in rates RPC
-- ============================================================================
-- Purpose: Update get_all_project_rates_for_month() to exclude member projects
--          so Rates and Revenue pages only show canonical projects.
-- ============================================================================

BEGIN;

-- ============================================================================
-- Update get_all_project_rates_for_month to filter out member projects
-- ============================================================================
...
COMMENT ON FUNCTION get_all_project_rates_for_month(DATE) IS 'Returns canonical projects (primaries and unassociated, excludes members) with effective rates, rounding, billing limits, active status, and carryover for a given month (for Rates page).';
...
DO $$
BEGIN
    RAISE NOTICE '033 Fix project grouping in rates migration complete';
    RAISE NOTICE '  - get_all_project_rates_for_month() now excludes member projects';
END $$;
