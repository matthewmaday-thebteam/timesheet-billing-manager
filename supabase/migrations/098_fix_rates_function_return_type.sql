-- Fix: get_all_project_rates_for_month() return type must match migration 093's
-- original definition. Migration 096/097 rewrites changed column names and
-- dropped existed_in_month. This restores the correct return type.
